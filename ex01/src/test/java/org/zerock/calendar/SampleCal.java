...
public class SampleCal {
	public static void main(String[] args) {
		...
		DateTimeFormatter fmt = DateTimeFormat.forPattern("yyyy-MM-dd").withLocale(Locale.US);
	...
	private static void printCalendar(ArrayList<String> listDay) {
		int dayInicator = 7;
		for (int i = 0; i < 5; i++) {
			List<String> weekRow = listDay.subList(i * dayInicator, (i + 1) * dayInicator);
			ArrayList<String> viewRow = (ArrayList<String>) convertFormat(weekRow, "D");
			System.out.println(String.join(" ", viewRow));
		}
	}
